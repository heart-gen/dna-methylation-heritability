...
#
# Module 03 step 1: assign donors to outer folds, once, for the whole run.
#
...
#   LSP_RUN_ID=<id> sbatch _h/step_1_prepare_folds.sh
...
log_job_info
run_r "${H_DIR}/01_prepare_folds.R" --run-id "$RUN_ID" $EXTRA
