# 05_cpg_meqtl_burden/_m — generated output only

Nothing in this directory is written by hand. Every file here is produced by a
script in `05_cpg_meqtl_burden/_h/` from locked configuration and declared inputs
(AGENTS.md §5.2).
...
3. Re-run the module's submission workflow from `05_cpg_meqtl_burden/_m`.
