...
## Main
output_path <- here("covar-analysis", "caudate", "global_ances", 
...
if (!dir.exists(output_path)) {
    dir.create(output_path, recursive = TRUE)
                                        ...
                                        # Set file paths
cpg_names <- here("covar-analysis", "caudate", "global_ances", "_m", "cpg",
...
pca <- here("covar-analysis", "caudate", "global_ances", "_m", "pca",
...
tmp_dir   <- here("covar-analysis", "caudate", "global_ances", "_m", "cpg", 
...
cpg_path <- here("covar-analysis", "caudate", "global_ances", "_m", "cpg", paste0("chr_", chr))
