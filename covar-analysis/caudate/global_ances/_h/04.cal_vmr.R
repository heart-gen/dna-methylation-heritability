...
## Main
                                        ...
                                        # load raw DNAm
load(here("covar-analysis/caudate/global_ances/_m/cpg", paste0("chr_", chr_num, "/stats.rda")))
output_path <- here("covar-analysis/caudate/global_ances/_m/vmr", paste0("chr_", chr_num))
