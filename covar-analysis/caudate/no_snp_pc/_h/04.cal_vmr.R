...
## Main
                                        ...
                                        # load raw DNAm
load(here("covar-analysis/caudate/no_snp_pc/_m/cpg", paste0("chr_", chr_num, "/stats.rda")))
output_path <- here("covar-analysis/caudate/no_snp_pc/_m/vmr", paste0("chr_", chr_num))
