...
## Main
output_path <- here("covar-analysis", "caudate", "no_snp_pc", 
...
if (!dir.exists(output_path)) {
    dir.create(output_path, recursive = TRUE)
                                        ...
                                        # Set file paths
cpg_names <- here("covar-analysis", "caudate", "no_snp_pc", "_m", "cpg",
...
pca <- here("covar-analysis", "caudate", "no_snp_pc", "_m", "pca",
...
cpg_path <- here("covar-analysis", "caudate", "no_snp_pc", "_m", "cpg", paste0("chr_", chr))
