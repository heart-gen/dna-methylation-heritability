...
get_vmr_list <- function(region) {
    base_dir <- here("covar-analysis", tolower(region), "no_snp_pc", "_m")
...
covar_path <- here("covar-analysis", "caudate", "no_snp_pc", "_m", "covs",
                    "chr_1", "TOPMed_LIBD.AA.covar")
qcovar_path <- here("covar-analysis", "caudate", "no_snp_pc", "_m", "covs",
