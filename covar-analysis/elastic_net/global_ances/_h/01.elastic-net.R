...
get_vmr_list <- function(region) {
    base_dir <- here("covar-analysis", tolower(region), "global_ances", "_m")
...
covar_path <- here("covar-analysis", "caudate", "global_ances", "_m", "covs",
                    "chr_1", "TOPMed_LIBD.AA.covar")
qcovar_path <- here("covar-analysis", "caudate", "global_ances", "_m", "covs",
