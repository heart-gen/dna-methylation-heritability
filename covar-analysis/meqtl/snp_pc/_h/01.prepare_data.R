...
#### Main
                                        ...
                                        # Create output dir
output_path <- here("covar-analysis", "meqtl", "snp_pc", "_m")
...
sample_file_path <- here("covar-analysis/caudate/snp_pc/_m/samples.txt")
...
#### Combine residualized methylation matrix
                                        ...
                                        # Read in .phen files
meth_file_path <- here("covar-analysis/caudate/snp_pc/_m/vmr")
...
#### Export annotation
bed_file_path <- here("covar-analysis/caudate/snp_pc/_m/vmr.bed")
