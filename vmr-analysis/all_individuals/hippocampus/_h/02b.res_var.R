...
## Main
output_path <- here("vmr-analysis", "all_individuals", "hippocampus", 
...
if (!dir.exists(output_path)) {
    dir.create(output_path, recursive = TRUE)
                                        ...
                                        # Set file paths
cpg_names       <- here("vmr-analysis", "all_individuals", "hippocampus", 
                        "_m", "cpg", paste0("chr_", chr), "cpg_pos.txt")
pheno_file_path <- here("inputs", "phenotypes", "_m", "phenotypes-all.tsv")
pca             <- here("vmr-analysis", "all_individuals", "hippocampus", 
                        "_m", "pca", paste0("chr_", chr), "pc.csv")
...
cpg_path <- here("vmr-analysis", "all_individuals", "hippocampus", 
