...
## AGENTS.md 7.2: preserve the calibration model and checksum. This historical
## checksum remains pinned until a low_h2_ordering_v2 model passes fresh
## validation and its checksum is explicitly promoted. The gate-version check
## blocks this historical model from new production in the meantime. Verifying
## SHA-256 here prevents any silent model swap during that transition.
