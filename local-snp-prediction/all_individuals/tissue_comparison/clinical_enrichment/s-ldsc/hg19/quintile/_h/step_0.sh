...
SCRIPT_DIR="/projects/b1213/users/elisa/dna-methylation-heritability/heritability/elastic_net_model/all_individuals/tissue_comparison/clinical_enrichment/s-ldsc/hg19/quintile/_h"
...
AA_SCRIPT="${SCRIPT_DIR}/region_heritability_AA.py"
EA_SCRIPT="${SCRIPT_DIR}/region_heritability_EA.py"
