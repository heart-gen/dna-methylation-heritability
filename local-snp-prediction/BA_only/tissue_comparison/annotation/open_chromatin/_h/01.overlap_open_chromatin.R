...
load_intergenic_vmrs <- function(tissue) {
...
cat("Loading intergenic VMRs across tissues...\n")
vmr_list <- lapply(TISSUES, load_intergenic_vmrs)
...
vmr_annotated_list <- lapply(TISSUES, function(tissue) {
  df <- vmr_list[[tissue]]
  vmr_gr <- GRanges(
...
fwrite(vmr_all, file.path(OUT_DIR, "intergenic_vmr_atac_overlap.tsv"), sep = "\t")
cat("Saved: intergenic_vmr_atac_overlap.tsv\n")
...
fwrite(fisher_df, file.path(OUT_DIR, "fishers_heritable_vs_nonheritable.tsv"), sep = "\t")
cat("Saved: fishers_heritable_vs_nonheritable.tsv\n")
...
fwrite(logistic_df, file.path(OUT_DIR, "logistic_continuous_h2.tsv"), sep = "\t")
cat("Saved: logistic_continuous_h2.tsv\n")
...
fwrite(quintile_df, file.path(OUT_DIR, "quintile_open_chromatin.tsv"), sep = "\t")
cat("Saved: quintile_open_chromatin.tsv\n")
...
fwrite(q5_df, file.path(OUT_DIR, "q5_vs_q1q4_fishers.tsv"), sep = "\t")
cat("Saved: q5_vs_q1q4_fishers.tsv\n")
