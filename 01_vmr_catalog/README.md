...
Machine-readable restatement of the Acceptance gate table above, in the schema
`00_shared/gates.R::read_accepted_runs()` parses (`cohort` / `region` columns,
under an `Accepted runs` heading). Adding it records an existing decision — it
does not re-decide anything. All six rows are the "all five pass" runs above;
the chr22 smoke run `vmrcat-AA-caudate-20260815-a` is deliberately absent.

| run_id | cohort | region | vmr_set_id | accepted_on | accepted_by | decision | notes |
|---|---|---|---|---|---|---|---|
| vmrcat-AA-caudate-20260816 | AA | caudate | vmrset-AA-caudate-937a41979978 | 2026-08-16 | Kynon J.M. Benjamin | ALL_FIVE_CRITERIA_PASS | 153 donors, 11,530 VMRs, 22 autosomes |
| vmrcat-AA-dlpfc-20260816 | AA | dlpfc | vmrset-AA-dlpfc-856067dfe289 | 2026-08-16 | Kynon J.M. Benjamin | ALL_FIVE_CRITERIA_PASS | 118 donors, 9,572 VMRs |
| vmrcat-AA-hippocampus-20260816 | AA | hippocampus | vmrset-AA-hippocampus-2d907b892215 | 2026-08-16 | Kynon J.M. Benjamin | ALL_FIVE_CRITERIA_PASS | 117 donors, 9,497 VMRs |
