...
#### Main
                                        ...
                                        # Create output dir
output_path <- here("meqtl-analysis", "vmrs", "dlpfc", "_m")
...
sample_file_path <- here("heritability/dlpfc/_m/samples.txt")
...
#### Combine residualized methylation matrix
                                        ...
                                        # Read in .phen files
meth_file_path <- here("heritability/dlpfc/_m_to_del/vmr")
...
#### Export annotation
bed_file_path <- here("heritability/dlpfc/_m_to_del/vmr.bed")
