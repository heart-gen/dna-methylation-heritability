# 07_transcription_splicing_coupling/_m — generated output only

Nothing in this directory is written by hand. Every file here is produced by a
script in `07_transcription_splicing_coupling/_h/` from locked configuration and declared inputs
(AGENTS.md §5.2).
...
3. Re-run the module's submission workflow from `07_transcription_splicing_coupling/_m`.
