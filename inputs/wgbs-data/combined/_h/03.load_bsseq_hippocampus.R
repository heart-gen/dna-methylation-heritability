## =============================================================================
## Load and Combine Hippocampus WGBS Data
## =============================================================================
##
## PURPOSE:
##   This script loads per-chromosome BSseq objects for the hippocampus,
##   combines them into a single genome-wide BSseq object, and saves as an
##   HDF5-backed SummarizedExperiment.
##
## INPUT:
##   - Per-chromosome HDF5SE from: inputs/wgbs-data/hippocampus/
##   - Phenotype data from: inputs/phenotypes/_m/phenotypes-AA.tsv
##
## OUTPUT:
##   - Combined BSseq object: inputs/wgbs-data/combined/_m/hippocampus_bsseq_h5se/
##   - Filtered phenotype data: inputs/wgbs-data/combined/_m/hippocampus_phenotypes.csv
##
## NOTE:
##   Hippocampus data is stored as HDF5SummarizedExperiment (not RDA),
##   similar to DLPFC.
## =============================================================================
suppressMessages({
    library(here)
...
bs_list <- bplapply(chromosomes, function(chr) {
    message("  Loading ", chr, "...")
                                        # Hippocampus uses HDF5SE format
