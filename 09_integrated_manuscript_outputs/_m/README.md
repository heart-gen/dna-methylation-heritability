# 09_integrated_manuscript_outputs/_m — generated output only

Nothing in this directory is written by hand. Every file here is produced by a
script in `09_integrated_manuscript_outputs/_h/` from locked configuration and declared inputs
(AGENTS.md §5.2).
...
3. Re-run the module's submission workflow from `09_integrated_manuscript_outputs/_m`.
