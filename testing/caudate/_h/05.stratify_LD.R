...
write.table(lb1_snp, file=file.path(output,"snp_group1.txt"), row.names=F, quote=F, col.names=F)
write.table(lb2_snp, file=file.path(output,"snp_group2.txt"), row.names=F, quote=F, col.names=F)
write.table(lb3_snp, file=file.path(output,"snp_group3.txt"), row.names=F, quote=F, col.names=F)
write.table(lb4_snp, file=file.path(output,"snp_group4.txt"), row.names=F, quote=F, col.names=F)
