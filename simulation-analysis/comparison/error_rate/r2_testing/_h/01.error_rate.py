...
parser = argparse.ArgumentParser(
        description="This script conducts error rate analysis for varying r2 thresholds"
    )
parser.add_argument("--r2_thresh", required=True, type=float)
args = parser.parse_args()
r2_thresh = args.r2_thresh

THRESHOLDS = {
    "heritability": 0.1,
    "r_squared_cv": r2_thresh,
    "fdr": 0.05
}
...
def main():
    ...
    power_df.write_csv(f"power-analysis_r2_{r2_thresh}.tsv", separator="\t")
    # Session information
    session_info.show()
