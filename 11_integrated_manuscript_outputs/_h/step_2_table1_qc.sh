...
run_r "11_integrated_manuscript_outputs/_h/04_table1_cohort.R" --run-id "$RUN_ID"

log_message "[10] cross-region sample-integrity screen"
run_r "11_integrated_manuscript_outputs/_h/05_qc_sample_integrity.R" --run-id "$RUN_ID"
