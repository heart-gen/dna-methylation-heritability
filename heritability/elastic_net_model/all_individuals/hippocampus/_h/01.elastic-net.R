...
covar_path <- here("vmr-analysis", "all_individuals", "hippocampus", "_m", 
                    "covs", "chr_1", "TOPMed_LIBD.covar")
qcovar_path <- here("vmr-analysis", "all_individuals", "hippocampus", "_m",     
                    "covs", "chr_1", "TOPMed_LIBD.qcovar")
