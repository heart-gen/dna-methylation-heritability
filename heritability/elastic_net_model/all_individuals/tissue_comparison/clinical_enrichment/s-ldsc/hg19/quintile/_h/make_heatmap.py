...
# Load data
# =========================
df = pd.read_csv("summary_table_fdr_EA.tsv", sep="\t")
...
# Labels
plt.title("EA-subset Coefficient Z-scores")
plt.xlabel("Quintile")
...
# Save outputs
# =========================
plt.savefig("EA_subset.pdf", bbox_inches="tight")
plt.savefig("EA_subset.png", dpi=300, bbox_inches="tight")
