...
FISHER_F   <- file.path(OUT_DIR, "fishers_repeat_enrichment.tsv")
LOGISTIC_F <- file.path(OUT_DIR, "logistic_repeat_enrichment.tsv")
VMR_F      <- file.path(OUT_DIR, "vmr_repeat_overlap.tsv")
...
save_plot(fig_main,        "repeat_elements_main",              width = 10.8, height = 6.5)
save_plot(fig_A,           "repeat_elements_logistic_class",    width = 8.6,  height = 4.5)
save_plot(fig_B,           "repeat_elements_quintiles",         width = 7.8,  height = 3.5)
save_plot(fig_family,      "repeat_elements_logistic_family",   width = 8.6,  height = 5.0)
save_plot(fig_fisher_supp, "repeat_elements_fishers_class_supp", width = 8.6, height = 6.0)
