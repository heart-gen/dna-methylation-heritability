...
FISHER_F <- file.path(OUT_DIR, "fishers_repressive_enrichment.tsv")
RATE_F   <- file.path(OUT_DIR, "chromhmm_state_overlap_rates.tsv")
VMR_F    <- file.path(OUT_DIR, "vmr_repressive_overlap.tsv")
...
fwrite(
  quintile_summary,
  file.path(OUT_DIR, "repressive_quintile_summary.tsv"),
  sep = "\t"
)
