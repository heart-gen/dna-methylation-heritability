...
get_overlaps <- function(vmr_all, h2_cat, tissue1, tissue2){
  overlap_fn <- paste0("F_0.25/", tissue1, "_", tissue2, "_overlap_0.25.bed")
...
out_path <- here("heritability/elastic_net_model/BA_only/tissue_comparison/h2_pairwise_corr/_m")
