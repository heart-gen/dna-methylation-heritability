...
def main():
    ...
    input = here('heritability', 'gcta', 'dlpfc', '_m', 'h2', f'chr_{args.chr}', f'TOPMed_LIBD.AA.{args.start_pos}_{args.end_pos}.hsq')

                                        # define output directory
    output = here('heritability', 'gcta', 'dlpfc', '_m', 'summary', f'chr_{args.chr}')
